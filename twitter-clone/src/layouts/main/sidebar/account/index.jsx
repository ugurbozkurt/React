    ...
    return (
        <div className="mt-auto ">
            <Popover className="relative">
                    <Popover.Button className="my-3 rounded-full p-3 flex w-full text-left hover:bg-[#EFF3F41A] outline-none " >
                       ...
                       <div className="mx-5 text-[15px] ml-3">
                            <div className="w-full h-5 flex">
                                ...
                                {account.isLocked &&
                                 (
                                    <svg viewBox="0 0 24 24" width={18.75} height={18.75} className="my-0.5 py-0.5">
                       ...
                       <div>
                        ...
                        <div className="w-[7px] h-[7px] flex absolute top-[21px] right-[9px]  rounded-full bg-[#1d9bf0]"/>
                        )}
                    ...
                    >
                <Popover.Panel className="w-[300px] bottom-[80px] left-1/2 -translate-x-1/2 py-4 mb-2 absolute bg-black shadow-box transition-colors rounded-2xl overflow-hidden">
                              {({close})=>(
                                    <More close={close}/>
