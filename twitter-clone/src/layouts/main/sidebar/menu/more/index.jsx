...
export default function More(){
    return (
            <Popover className="relative">
                <Popover.Button className="h-14 block outline-none">
                ...
                <Disclosure>
                    <Disclosure.Button className="h-[52px] w-full flex items-center transition-colors justify-between px-4 font-bold hover:bg-[#EFF3F41A]">
                        Creator Studio
                        <svg viewBox="0 0 24 24" width={18.75} height={18.75}  >
                            <path fill="#fff" d="M3.543 8.96l1.414-1.42L12 14.59l7.043-7.05 1.414 1.42L12 17.41 3.543 8.96z"></path>
                        </svg>
                    </Disclosure.Button>
                    <Disclosure.Panel >
                    <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium hover:bg-[#EFF3F41A]">
                        <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
                        <path fill="#fff" d="M8.75 21V3h2v18h-2zM18 21V8.5h2V21h-2zM4 21l.004-10h2L6 21H4zm9.248 0v-7h2v7h-2z"></path>
                        </svg>
                            Analytics
                        </Link>
                    </Disclosure.Panel>
                ...
                <Disclosure>
                    ...
                    <Disclosure.Panel >
                        <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium hover:bg-[#EFF3F41A]">
                        <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
                        <path fill="#fff" d="M1.996 5.5c0-1.38 1.119-2.5 2.5-2.5h15c1.38 0 2.5 1.12 2.5 2.5v13c0 1.38-1.12 2.5-2.5 2.5h-15c-1.381 0-2.5-1.12-2.5-2.5v-13zm2.5-.5c-.277 0-.5.22-.5.5v13c0 .28.223.5.5.5h15c.276 0 .5-.22.5-.5v-13c0-.28-.224-.5-.5-.5h-15zm8.085 5H8.996V8h7v7h-2v-3.59l-5.293 5.3-1.415-1.42L12.581 10z"></path>
                        </svg>
                            Ads
                        </Link>
                    </Disclosure.Panel>
                ...
                <Disclosure>
                    ...
                    <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium hover:bg-[#EFF3F41A]">
                        ...
                        <path fill="#1D9BF0" d="M14 12c0-1.1-.9-2-2-2-1.11 0-2 .9-2 2v2h2c1.1 0 2-.9 2-2z"></path>
                        </svg>
                            Display
                    </Link>
                    <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium hover:bg-[#EFF3F41A]">
