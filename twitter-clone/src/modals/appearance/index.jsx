  ...
  return (
    <div className="w-[600px] h-[625px] bg-black rounded-2xl" >
      ...
      <div className="px-8">
        ...
        <div className="w-full h-[56px] rounded-2xl bg-[#16181c] gap-[50px] flex items-center justify-center">
        ...
        <div className="w-full h-[80px] rounded-2xl bg-[#16181c] gap-3 flex items-center justify-center">
          <button
            onClick={() => setBackgroundColor({ name: 'default', color: '#FFF' })}
            type="button"
          ...
          <button
            onClick={() => setBackgroundColor({ name: 'dim', color: '#15202b' })}
            type="button"
          ...
          <button
            onClick={() => setBackgroundColor({ name: 'lights out', color: '#000' })}
            type="button"
